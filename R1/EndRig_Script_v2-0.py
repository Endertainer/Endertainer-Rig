...
class InfoPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        b = layout.box()
        r = b.row(align=True)
        r.label(text= "Rig UI v2.0", icon= 'TEXT')
        r = b.row(align=True)
        ...
        if obj.get("rig_version") == "R1_v1-1":
            r.label(text= "Endertainer Rig R1 v1.1", icon= 'OUTLINER_OB_ARMATURE')
...
#--->               / Version Checker (R1_v1-0 above)
                    if obj.get("rig_version") == "R1_v1-0" or obj.get("rig_version") == "R1_v1-1":
                        bb1 = b1.box()
                        cc1 = bb1.column(align=True)
                        if scr.use_simplify:
                            cc1.prop(scr, "use_simplify", text='Enable Simplify')
                        else:
                            cc1.prop(scr, "use_simplify", text='Enable Simplify')
                        if scr.use_simplify == True:
                            cc1.prop(scr, "simplify_subdivision", text = "Max Subdivision")
                    c1 = b1.column(align=True)
...
#--->               / Version Checker (R1_v1-0 above)
                    if obj.get("rig_version") == "R1_v1-0" or obj.get("rig_version") == "R1_v1-1":
                        bb2 = b2.box()
                        cc2 = bb2.column(align=True)
                        if sdo.show_wireframes:
                            cc2.prop(sdo, "show_wireframes", text='Enable Wireframes')
                        else:
                            cc2.prop(sdo, "show_wireframes", text='Enable Wireframes')
                        if sdo.show_wireframes == True:
                            cc2.prop(sdo, "wireframe_opacity", text = "Line Opacity")
                    c2 = b2.column(align=True)
